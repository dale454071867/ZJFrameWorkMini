...
-(NSDateComponents*)agoFromNowCalendarUnit:(NSCalendarUnit)calendarunit
{
    ...
    NSCalendar *calendar = [NSCalendar calendarWithIdentifier:NSCalendarIdentifierGregorian];//公历
    NSDateComponents *dateComponents = [calendar components:calendarunit fromDate:self toDate:nowDate options:NSCalendarWrapComponents];
